...
/*
In accordance with apache 2.0 license, I declare that this is a modified copy
of main.go from camlistore. (http://camlistore.org)
...
func main() {
	...
	if *verbose {
		log.Printf("program version = %s", version)
